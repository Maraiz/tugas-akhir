...
function BkrTable() {
    ...
    async function saveEdit() {
        ...
        try {
            ...
            await api.put(`/bkr/${editTarget.id}`, { rows: rowsPayload });

            closeEditModal();
            fetchPeriods(); // refresh list biar rataCapaian ke-update
        } catch (error) {
            console.error(error);
    ...
    // Hitung ulang % secara live buat ditampilkan sambil user ngetik
