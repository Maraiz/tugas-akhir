...
/* ===================== FIELD DEFINITION UNTUK PIK-R ===================== */
/* Mengacu pada TABEL 7A SIGA — hanya kolom 1,2,3,4,6 yang dipakai:
   1=Kode, 2=Kecamatan, 3=Yang Ada, 4=Yang Lapor,
   6=Jumlah PIK Remaja Menyajikan Materi PKBR (dipakai sbg "Jumlah Remaja
   Hadir Pertemuan Sosialisasi PKBR" di laporan MONEV, sesuai data asli).
   Kolom lain (Lainnya, Jumlah Pertemuan, Jumlah Remaja Hadir Pertemuan,
   Jumlah Pertemuan Materi PKBR) diabaikan */
const PIKR_FIELDS = [
    { key: "kode", label: "Kode" },
    { key: "kecamatan", label: "Kecamatan" },
    { key: "ada", label: "Jumlah Poktan - ADA (kolom 3)" },
    { key: "lapor", label: "Jumlah Poktan - LAPOR (kolom 4)" },
    { key: "jumlah_pkbr", label: "Jumlah Remaja Hadir Pertemuan Sosialisasi PKBR (kolom 6)" },
...
const OFFSET_PIKR = { kode: -1, kecamatan: 0, ada: 1, lapor: 2, jumlah_pkbr: 4 };
...
function AddPikrWizard() {
    ...
    function initColumnSelection() {
        const positionMap = buildPositionMapFromHeaders(rawHeaders, OFFSET_PIKR);
    ...
    function buildPreview() {
        ...
        const totalPkbr = data.reduce((s, r) => s + (Number(r.jumlah_pkbr) || 0), 0);
        const totalPctLapor = totalAda > 0 ? (totalLapor / totalAda) * 100 : 0;

        setTotals({ totalAda, totalLapor, totalPkbr, totalPctLapor });
    }
    ...
    return (
        <>
            ...
            {currentStep === 1 && (
                <div className="step-panel active">
                    <div className="panel-head">
                        ...
                        <p>Unggah hasil unduhan data PIK-R (Tabel 7A) dari aplikasi SIGA dalam format Excel (.xlsx / .xls / .csv)</p>
                    </div>
            ...
            {currentStep === 3 && (
                <div className="step-panel active">
                    <div className="panel-head">
                        ...
                        <p>Sistem otomatis mendeteksi dan mencentang kolom yang dibutuhkan (kolom 1,2,3,4,6). Sesuaikan pemetaan kolom jika diperlukan.</p>
                    </div>
            ...
            {currentStep === 4 && (
                <div className="step-panel active">
                    <div className="panel-head">
                        <h3>Preview Hasil Data — MONEV POKTAN PIK-R</h3>
                        <p>Data mentah SIGA telah disaring menjadi format rekap MONEV POKTAN PIK-R yang Melaksanakan Edukasi Kespro: Jumlah Poktan (Ada/Lapor) dan Jumlah Remaja Hadir Pertemuan Sosialisasi PKBR</p>
                    </div>
                    ...
                    <div className="success-box">
                        ...
                        <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
                            ...
                            <button
                                ...
                                onClick={() => navigate("/admin/monitoring/pikr")}
                            >
                                Kembali ke Data PIK-R
                            </button>
                        </div>
                    </div>
                </div>
