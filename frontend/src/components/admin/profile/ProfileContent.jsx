...
function ProfileContent() {
    ...
    async function saveProfile() {
        ...
        try {
            ...
            // Update juga data user di localStorage biar Sidebar/Header
            // ikut nunjukkin nama/foto terbaru tanpa perlu logout dulu
    ...
    if (loadError) {
        return (
            <div className="pf-card" style={{ textAlign: "center", padding: 40 }}>
                ...
                <button className="pf-btn-secondary" onClick={fetchProfile}>Coba Lagi</button>
            </div>
        );
    }

    // File statis (uploads/) di-serve di LUAR prefix /api, jadi suffix
    // "/api" di baseURL harus dibuang dulu sebelum nyusun URL foto
            ...
            <div className="pf-grid">
                ...
                <div className="pf-card pf-side-card">
                    <div className="pf-avatar-wrap">
                        {fotoSrc ? (
                            <img src={fotoSrc} alt="Foto profil" className="pf-avatar-img" />
                        ) : (
                            <div className="pf-avatar-fallback">{initials(profile.nama)}</div>
                        )}
                        <button
                    ...
                    <h3 className="pf-side-name">{profile.nama}</h3>
                    <span className="pf-side-role">{ROLE_LABEL[profile.role] || profile.role}</span>

                    <div className="pf-side-info-list">
                        <div className="pf-side-info-item">
                ...
                <div className="pf-main-col">
                    ...
                    <div className="pf-card">
                        ...
                        <div className="pf-form-footer">
                            <button className="pf-btn-primary" onClick={saveProfile} disabled={savingProfile}>
                    ...
                    <div className="pf-card">
                        ...
                        <label className="pf-show-pw-toggle">
                            <input type="checkbox" checked={showPw} onChange={(e) => setShowPw(e.target.checked)} />
                            Tampilkan password
                        </label>

                        <div className="pf-form-footer">
                            <button className="pf-btn-primary danger" onClick={savePassword} disabled={savingPassword}>
