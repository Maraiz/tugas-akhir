...
const BkrPeriode = sequelize.define(
    "bkr_periodes",
    {
        id: {
        ...
        diuploadOlehNama: {
            type: DataTypes.STRING, // disimpan langsung (denormalized) biar list gak perlu join ke users
            allowNull: true,
        },
    },
    {
        tableName: "bkr_periodes",
        timestamps: true,
