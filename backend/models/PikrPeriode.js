...
const PikrPeriode = sequelize.define(
    "pikr_periodes",
    {
        id: {
        ...
        rataCapaian: {
            type: DataTypes.FLOAT, // rata-rata % Pelaporan (Lapor/Ada) seluruh kecamatan
            allowNull: false,
            defaultValue: 0,
        },
